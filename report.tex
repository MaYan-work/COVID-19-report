...
\author{\sf\Large\textbf{ Yan Ma}\\ {\sf\large XXX\\[0.5cm]} \sf\Large\textbf{ Reports XXXX}\\ {\sf\large XXX\\[0.5cm]} \sf\Large\textbf{ XXX XXX}\\ {\sf\large XXX\\[0.5cm]}}

\date{\sf\Date~\Month~\Year}
\makeatletter
\lfoot{\sf Ma, XXXX, XXX: \@date}
\makeatother
...
\hypertarget{the-packages-used-in-this-section-is}{%
\section{The packages used in this section is:}\label{the-packages-used-in-this-section-is}}
