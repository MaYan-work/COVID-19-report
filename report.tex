...
\author{\sf\Large\textbf{ Jimmy Effendy}\\ {\sf\large XXX\\[0.5cm]} \sf\Large\textbf{ Reports XXXX}\\ {\sf\large XXX\\[0.5cm]} \sf\Large\textbf{ XXX XXX}\\ {\sf\large XXX\\[0.5cm]}}

\date{\sf\Date~\Month~\Year}
\makeatletter
\lfoot{\sf Effendy, XXXX, XXX: \@date}
\makeatother
...
By the end of April, the number of cases in the US is approximately four times larger in comparison to Italy.

According to \autocite{vox} the number of COVID-19 cases in the US make up approximately a third of the world's cases.
...
\hline
\rowcolor{gray!6}  CHN & 83991 & 4637\\
\hline
JPN & 15747 & 613\\
\hline
\end{tabular}
...
{\centering \includegraphics{report_files/figure-latex/fig1-2} 
